    ...
    <div className="relative w-full h-screen bg-neutral-100 flex items-center justify-center">
      ...
      <div className="relative z-10 w-11/12 md:w-3/4 lg:w-1/2 p-8 bg-white/70 backdrop-blur-sm rounded-lg shadow-xl text-center">
        ...
        <p className="font-sans text-neutral-700 text-sm sm:text-base mb-6 leading-relaxed">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam lobortis dolor
          quis neque tempor, sollicitudin porta ante feugiat. Duis mauris lacus,
          fermentum quis consectetur quis, aliquet sit amet metus. Pellentesque ac
          sagittis nisi.
        </p>
        <button className="bg-amber-800 hover:bg-amber-900 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-colors duration-300 transform hover:scale-105">
          SHOP NOW
        </button>
      </div>
    </div>
